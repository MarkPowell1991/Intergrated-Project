...
public class TextAreaAlphaNumericalValidator extends StringValidator {

    public TextAreaAlphaNumericalValidator(JComponent inputField, int minLenght, int maxLenght, boolean mustContinuous) {
    ...
    public boolean validationCriteria(JComponent component) {                       
        this.input = ((JTextArea) component).getText().toLowerCase(); 
